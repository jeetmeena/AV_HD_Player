...
import com.example.geetmeena.music.MediaNotificationManager;
...
public class MediaPlayerService  extends MediaBrowserServiceCompat {
   ...
   IntentFilter intentFilter;
    ...
    public void onCreate() {
        ...
        headPhoneBrodCost=new HeadPhoneBrodCost();
        registerReceiver(headPhoneBrodCost,intentFilter);
   ...
   public class HeadPhoneBrodCost extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
          //  Toast.makeText(context, "Head Phone dedcted", Toast.LENGTH_SHORT).show();
