...
import com.example.geetmeena.music.ViewReso;
   ...
   // int mCurrentState;
    ...
    private void updateMetadata(MediaMetadataCompat metadata) {
       ...
       try {
        ...
        mainActivity.imageView.setImageBitmap(metadata== null ? BitmapFactory.decodeResource(Resources.getSystem(), R.drawable.nightclub_w) :
                metadata.getBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART));
      ...
      // View views  =   inflater.inflate(R.layout.bottom_sheet,AudioFragment.this,true);
        ...
        public void onBindViewHolder(@NonNull SolventHolders holder, final int position) {
           ...
           // mediaMetadataRetriever.setDataSource(CommonModel.getFilePath(itemList.get(position).getMediaId()));
            MediaMetadataCompat matadta=CommonModel.getMetadata(getActivity().getBaseContext(),itemList.get(position).getMediaId());
            ...
            try {
                ...
                //CommonModel.getFilePath(itemList.get(position).getMediaId()),0
              // Toast.makeText(getActivity().getBaseContext(), "UpDateMataData"+ matadta.getBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART), Toast.LENGTH_SHORT).show();

                Bitmap bit=matadta.getBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART);
                String nam=name( matadta.getDescription().getTitle().toString());
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(i==0){
                 showSongLists(itemPostion);
                    ...
                    mediaMetadataRetriever.setDataSource(CommonModel.getFilePath(audioList.get(itemPostion).getMediaId()));
